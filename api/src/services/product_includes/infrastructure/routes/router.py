...
async def create_include(product_id: int, body: CreateIncludeRequest, current_user: dict = Depends(require_admin_or_soporte)):
...
async def update_include(product_id: int, include_id: int, body: UpdateIncludeRequest, current_user: dict = Depends(require_admin_or_soporte)):
...
async def delete_include(product_id: int, include_id: int, current_user: dict = Depends(require_admin_or_soporte)):
