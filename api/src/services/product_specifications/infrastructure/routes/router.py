...
async def create_specification(product_id: int, body: CreateSpecificationRequest, current_user: dict = Depends(require_admin)):
...
async def update_specification(product_id: int, specification_id: int, body: UpdateSpecificationRequest, current_user: dict = Depends(require_admin)):
...
async def delete_specification(product_id: int, specification_id: int, current_user: dict = Depends(require_admin)):
